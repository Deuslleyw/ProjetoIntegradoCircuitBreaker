package com.deusleyDev.api_publication.controller;
...
import com.deusleyDev.api_publication.service.PublicationService;
...
public class PublicationController {
    ...
    public void insert(@Valid @RequestBody PublicationRequest publicationRequest){
        var publication = publicationMapper.toPublicationRequest(publicationRequest);
